...
# This file was *autogenerated* from the file divisiontrials.sage
from sage.all_cmdline import *   # import sage library

_sage_const_15 = Integer(15); _sage_const_6 = Integer(6); _sage_const_0 = Integer(0); _sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0x2 = Integer(0x2); _sage_const_0xD = Integer(0xD); _sage_const_0x3 = Integer(0x3); _sage_const_0x9 = Integer(0x9); _sage_const_0x7 = Integer(0x7); _sage_const_0xB = Integer(0xB); _sage_const_0xA = Integer(0xA); _sage_const_0x6 = Integer(0x6); _sage_const_0xE = Integer(0xE); _sage_const_0x0 = Integer(0x0); _sage_const_0xF = Integer(0xF); _sage_const_0x4 = Integer(0x4); _sage_const_0x8 = Integer(0x8); _sage_const_0x5 = Integer(0x5); _sage_const_0x1 = Integer(0x1); _sage_const_0xC = Integer(0xC)
...
def SBOX_ANF(SBOX):
    ...
    SBOX_bits = [x.bits() + [_sage_const_0  for i in range(n - len(x.bits()))] for x in SBOX]
    # print("SBOX_bits:")
    # print(SBOX_bits)
    ...
    y0 = B[_sage_const_0 ].algebraic_normal_form()
    # print("y0:-----------")
    # print(y0)
    P = y0.ring()
...
def SboxDivTrailTable(y):
    ...
    for c in range(_sage_const_2  ** n):
        k = Integer(c).bits() + [_sage_const_0  for i in range(n - Integer(c).nbits())]
        k = tuple(k)
        # print("----k=:" + str(k))
...
def SboxDivTrail(y, k):
    ...
    S = set()
    for e in range(_sage_const_2  ** n):
        kbar = Integer(e).bits() + [_sage_const_0  for i in range(n - Integer(e).nbits())]
        if greater(kbar, k):
            S.add(tuple(kbar))

    F = set()
    for kbar in S:
        F.add(P(prod([x[i] for i in range(n) if kbar[i] == _sage_const_1 ])))

    Kbar = set()

    for e in range(_sage_const_2  ** n):
        u = Integer(e).bits() + [_sage_const_0  for i in range(n - Integer(e).nbits())]
        # print("--------------[SboxDivTrail]:1-----------")
        puy = prod([y[i] for i in range(n) if u[i] == _sage_const_1 ])
...
if __name__ == "__main__":
    ...
    cipher_name = "sbox_4"
    sbox = [_sage_const_0x2 , _sage_const_0xD , _sage_const_0x3 , _sage_const_0x9 , _sage_const_0x7 , _sage_const_0xB , _sage_const_0xA , _sage_const_0x6 , _sage_const_0xE , _sage_const_0x0 , _sage_const_0xF , _sage_const_0x4 , _sage_const_0x8 , _sage_const_0x5 , _sage_const_0x1 , _sage_const_0xC ]
    time_start = time.time()
    (P, y) = SBOX_ANF(sbox)
