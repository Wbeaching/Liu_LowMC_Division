...
class LowMCMILP:
    def __init__(self, n, r, active_height, filename_model, filename_result):
        self.block_size = n
        # 128
        self.round_num = r
    ...
    def clean_ANF(self):
        file_ANF = 'anf_of_sbox+linear-m_10-n_128.txt'
        anf = open(file_ANF, "r")
        ANF_xi = []
        anf_str = ''
        for i in anf:
    ...
    def create_model(self, input_height):
        self.create_target_fn()
        self.input_init_new(input_height)
